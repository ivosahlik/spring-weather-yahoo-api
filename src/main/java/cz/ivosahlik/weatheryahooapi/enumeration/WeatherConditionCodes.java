...
/**
 * Intellij Idea
 * Created by ivosahlik on 12/05/2018
 */
public enum WeatherConditionCodes {
    ...
    private WeatherConditionCodes(int code, int character) {
        this.code = code;
        this.character = character;
    }

    public static WeatherConditionCodes fromInt(int code) {
        for (WeatherConditionCodes weatherCondition : WeatherConditionCodes.values()) {
            if (weatherCondition.code == code) {
    ...
    public String getWeatherFontCode() {
